...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """was_publishe_recently() returns False for questions whose pub_date is in the future"""
...
def create_question(question_text, days, with_choice = True):
    ...
    if with_choice:
        new_question.choice_set.add(Choice.objects.create(question = new_question, choice_text = "choice", votes = 0))
    return  new_question
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_question_without_choices(self):
        """
        The questions with no choices are not displayed.
        """
        question_without_choices = create_question(question_text="question without choices", days=-10, with_choice=False)
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        the question's text and vote options.
        """
